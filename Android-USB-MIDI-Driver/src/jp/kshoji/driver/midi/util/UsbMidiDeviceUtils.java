...
public final class UsbMidiDeviceUtils {
    ...
    public static Set<MidiInputDevice> findMidiInputDevices( UsbDevice usbDevice,  UsbDeviceConnection usbDeviceConnection,  List<DeviceFilter> deviceFilters) {
		Set<MidiInputDevice> devices = new HashSet<MidiInputDevice>();
        Set<Integer> registeredEndpointNumbers = new HashSet<Integer>();
    ...
    public static String getProductName( UsbDevice usbDevice,  UsbDeviceConnection usbDeviceConnection) {
    ...
    public static String getManufacturerName( UsbDevice usbDevice,  UsbDeviceConnection usbDeviceConnection) {
